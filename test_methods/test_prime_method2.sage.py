# This file was *autogenerated* from the file test_prime_method2.sage
...
#	global omega1, omega6, omega7
	...
	for test_num in xrange(Integer(5)):
		...
		#		print exc
			...
			try:
				...
				omegap = method6(range(Integer(1),threshold+Integer(1)))
			...
			try:
				...
				omegap = method7(range(Integer(1),threshold+Integer(1)))
				omegap = map(itemgetter(-Integer(1)), omegap)
...
def choose_test(test_number):
	...
	phi_j2 = [ delta[j] + q[j]**Integer(2)*z/(Integer(1)-delta[j].conjugate()*z) for j in
		xrange(len(q)) ]
	return None
